...
### notes 📝
* [Настраиваем профиль PowerShell 5.1](https://github.com/wincmd64/blog/wiki/Настраиваем-профиль-PowerShell-5.1)
* [Выбирает лучший резолвер DNS](https://github.com/wincmd64/blog/wiki/Выбирает-лучший-резолвер-DNS)
