...
### 📜 scripts
Несколько десятков скриптов, решающие различные задачи по автоматизации Windows. В основном это `bat\cmd`, а также `ps1` и `ahk`.  
Последняя новинка: [trid.bat](https://github.com/wincmd64/scripts/blob/main/send2_extras/trid.bat)  
